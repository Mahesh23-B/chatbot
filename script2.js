...
// API setup 
const API_KEY = "AIzaSyBgVe-8eA-12_yOzSiL4WWfZKW9pU-Lp20"; 
// Make sure the key is valid and authorized
...
const generateBotResponse = async (incomingMessageDiv) => {
    ...
    //  handle error in API response
        ...
        messageElement.style.colour = "#ff0000"
    } finally{
...
const handleOutgoingMessage = (e) => {
    ...
    messageInput.value = "";
    fileUploadWrapper.classList.remove("file-uplpaded");
    ...
    // Simulate bot response with indicator after delay
    setTimeout(() => {
...
fileInput.addEventListener("change", () =>{
    ...
    const reader = new FileReader();
     reader.onload = (e) => {
        ...
        fileUploadWrapper.classList.add("file-uplpaded");
